...
export const DAEMON_WORKER_ROLE_ENV = "AMIDE_INTERNAL_DAEMON_WORKER";
export const DAEMON_WORKER_TOKEN_ENV = "AMIDE_INTERNAL_DAEMON_WORKER_TOKEN";
export const DAEMON_WORKER_INSTANCE_ID_ENV = "AMIDE_INTERNAL_DAEMON_WORKER_INSTANCE_ID";
export const DAEMON_WORKER_ACTIVE_SESSION_ID_ENV = "AMIDE_INTERNAL_DAEMON_WORKER_ACTIVE_SESSION_ID";
export const DAEMON_WORKER_SUPERVISOR_SOCKET_ENV = "AMIDE_INTERNAL_DAEMON_SUPERVISOR_SOCKET";
export const DAEMON_WORKER_RECOVERY_JOURNAL_ENV = "AMIDE_INTERNAL_DAEMON_WORKER_RECOVERY_JOURNAL";
export const DAEMON_WORKER_STARTUP_GATE_FD_ENV = "AMIDE_INTERNAL_DAEMON_WORKER_STARTUP_GATE_FD";
